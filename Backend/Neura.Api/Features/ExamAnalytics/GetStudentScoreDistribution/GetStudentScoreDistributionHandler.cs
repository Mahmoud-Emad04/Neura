...
internal sealed class GetStudentScoreDistributionHandler(ApplicationDbContext context)
    : IRequestHandler<GetStudentScoreDistributionQuery, Result<ScoreDistributionResponse>>
{
    public async Task<Result<ScoreDistributionResponse>> Handle(
        GetStudentScoreDistributionQuery query, CancellationToken ct)
    {
