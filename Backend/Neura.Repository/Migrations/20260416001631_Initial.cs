        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordHandle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Bio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InstructorApprovedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionMask = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayInstructorName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    TotalRatingSum = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanReapplyAfter = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorApplications_AspNetUsers_ReviewedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseRoleId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    ...
                    InvitedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    ExpiresOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseInvitations_AspNetUsers_AcceptedUserId",
                        column: x => x.AcceptedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseInvitations_AspNetUsers_InvitedById",
                        column: x => x.InvitedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseInvitations_CourseRoles_CourseRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseLearningOutcomes", x => new { x.CourseId, x.Outcome });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePrerequisites", x => new { x.CourseId, x.Requirement });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseRoleId = table.Column<int>(type: "int", nullable: false),
                    PermissionMask = table.Column<int>(type: "int", nullable: false),
                    EnrolledOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    EnrolledById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseUsers_AspNetUsers_EnrolledById",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseUsers_CourseInvitations_InvitationId",
                        column: x => x.InvitationId,
                        principalTable: "CourseInvitations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CloudinaryVideoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CloudinaryPublicId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsVideoPrivate = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostComments_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_AcceptedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_CourseId_Email_Status",
                table: "CourseInvitations",
                columns: new[] { "CourseId", "Email", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_CourseId_Status",
                table: "CourseInvitations",
                columns: new[] { "CourseId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_CourseRoleId",
                table: "CourseInvitations",
                column: "CourseRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_Email",
                table: "CourseInvitations",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_InvitedById",
                table: "CourseInvitations",
                column: "InvitedById");

            migrationBuilder.CreateIndex(
                name: "IX_CourseInvitations_Token",
                table: "CourseInvitations",
                column: "Token",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseRoles_Level",
                table: "CourseRoles",
                column: "Level");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRoles_Name",
                table: "CourseRoles",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseUsers_CourseId_IsDeleted",
                table: "CourseUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseUsers_EnrolledById",
                table: "CourseUsers",
                column: "EnrolledById");

            migrationBuilder.CreateIndex(
                name: "IX_CourseUsers_InvitationId",
                table: "CourseUsers",
                column: "InvitationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorApplications_ReviewedById",
                table: "InstructorApplications",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorApplications_Status",
                table: "InstructorApplications",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorApplications_Status_CreatedOn",
                table: "InstructorApplications",
