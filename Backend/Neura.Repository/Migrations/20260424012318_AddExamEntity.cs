        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassingScorePercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    NumberOfQuestionsToServe = table.Column<int>(type: "int", nullable: true),
                    EnableTabSwitchDetection = table.Column<bool>(type: "bit", nullable: false),
                    MaxViolationsBeforeAutoSubmit = table.Column<int>(type: "int", nullable: true),
                    ShowCorrectAnswersAfterSubmit = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerOrder = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptViolation", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptAnswerOptions", x => new { x.AttemptAnswerId, x.AnswerOptionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAttempts_Status_StartedAt",
                table: "ExamAttempts",
