...
public interface ICloudinaryService
{
    ...
    Task<Result<string>> UploadVideoAsync(IFormFile videoFile, int lessonId, bool isPrivate, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    Task<Result<CloudinaryVideoMetadata>> GetVideoMetadataAsync(string videoPublicId, CancellationToken cancellationToken = default);
}
