...
public static class CourseErrors
{
    ...
    public static readonly Error UserAlreadyEnrolled =
           new("Course.UserAlreadyEnrolled", "The user is already enrolled in this course.", StatusCodes.Status409Conflict);
    ...
    public static readonly Error OwnerCannotUnenroll =
        new("Course.OwnerCannotUnenroll", "The course owner cannot unenroll. You must transfer ownership or delete the course.", StatusCodes.Status400BadRequest);
}