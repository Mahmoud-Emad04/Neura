...
public static class AnnouncementErrors
{
    ...
    public static readonly Error PostAccessDenied =
        new("Post.AccessDenied", "You do not have permission to perform this action on this post.", StatusCodes.Status403Forbidden);
    ...
    public static readonly Error CommentAccessDenied =
        new("Comment.AccessDenied", "You do not have permission to perform this action on this comment.", StatusCodes.Status403Forbidden);
